# Notifies users when someone replies to their comment
class ReplyToCommentNotifier < ApplicationNotifier
  ...
  notification_methods do
    def message
      ...
      return "Someone replied to your comment" unless params[:commentable] && params[:user]
